...
if($resultset=getSQLResultset("SELECT carrito.id_producto,carrito.precio,carrito.cantidad, producto.n_producto, producto.foto1 FROM carrito inner join producto
